...
Route::middleware(['web', 'client-app'])->prefix('app/inbox')->name('client.inbox.')->group(function () {
    ...
    Route::get('/poll-conversations', [InboxController::class, 'pollConversations'])->name('poll-list');
    Route::post('/conversations/{conversation}/upload-media', [InboxController::class, 'uploadMedia'])->name('upload-media');
    Route::get('/conversations/{conversation}/poll', [InboxController::class, 'poll'])->name('poll');
    ...
    Route::get('/setup/oauth/redirect/{channel}', [InboxSetupController::class, 'oauthRedirect'])->name('setup.oauth.redirect');
    Route::get('/setup/oauth/callback/{channel}', [InboxSetupController::class, 'oauthCallback'])->name('setup.oauth.callback');
