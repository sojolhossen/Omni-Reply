...
class LandingPageController extends Controller
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            // ── SEO ─────────────────────────────────────────────────
            'landing.seo_title'       => 'Omni agent — One Inbox for WhatsApp, Messenger & Instagram',
            'landing.seo_description' => 'Omni agent unifies WhatsApp, Messenger and Instagram in one inbox with AI chatbots, no-code automation, bulk broadcasting and a built-in CRM. Start free — no credit card required.',
            ...
            'landing.solution_title'   => 'Omni agent fixes all of it',
            ...
            'landing.integrations_strip_subtitle' => 'Connect Omni agent to 100+ apps via native integrations, webhooks and our REST API.',

            // ── Why us ──────────────────────────────────────────────
            'landing.why_enabled'   => '1',
            'landing.why_badge'     => 'Why Omni agent',
            ...
            'landing.testimonials_subtitle'  => 'See what businesses are saying about Omni agent.',
            ...
            'landing.faq_subtitle'  => 'Everything you need to know about Omni agent.',
            'landing.faq_1_q'       => 'Which channels does Omni agent support?',
            ...
            'landing.faq_2_a'       => 'Yes — Omni agent connects through the official Meta WhatsApp Cloud API. Our guided setup walks you through it in minutes.',
            'landing.faq_3_q'       => 'Can I try Omni agent before paying?',
            ...
            'landing.cta_subtitle'  => 'Join 12,000+ businesses growing faster with Omni agent. Start free — no credit card required.',
            'landing.cta_primary'   => 'Start Free Trial',
            'landing.cta_secondary' => 'Talk to Sales',

            // ── About page ──────────────────────────────────────────
            'landing.about_badge'       => 'About Omni agent',
            'landing.about_title'       => 'We are on a mission to make business conversations effortless',
            'landing.about_subtitle'    => 'Omni agent helps thousands of businesses turn everyday messages into lasting customer relationships.',
            'landing.about_story_title' => 'Our story',
            'landing.about_story_body'  => "Omni agent started with a simple frustration: customer conversations were scattered across too many apps, and great leads were slipping through the cracks.\n\nWe set out to build one platform where every WhatsApp, Messenger and Instagram conversation lives together — supercharged with AI and automation. Today, teams in over 60 countries use Omni agent to reply faster, sell more and build relationships that last.",
            ...
            'landing.integrations_page_title'    => 'Connect Omni agent to your entire stack',
            'landing.integrations_page_subtitle' => 'Native integrations, webhooks and a full REST API — bring Omni agent into the tools your team already loves.',
