                    ...
                    {items.map((item, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {Number(item.badge) > 0 && (
                                    <span className="ml-auto inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 text-[11px] font-bold leading-none text-white bg-brand-500 rounded-full shrink-0 shadow-sm">
                                        {item.badge > 99 ? '99+' : item.badge}
                                    </span>
                                )}
                                {isActive && !Number(item.badge) && (
...
export default function Sidebar({
    ...
    const appName = import.meta.env.VITE_APP_NAME || 'Omni agent';
        ...
        <aside className="flex h-full w-64 flex-col bg-secondary-900 dark:bg-neutral-900">
            ...
            <div className="flex h-14 shrink-0 items-center gap-2.5 px-4 border-b border-white/8">
                {logoUrl ? (
                    ...
                    <img src="/omni_agent-logo.png" alt={appName} className="h-10 w-auto max-w-[200px] object-contain" />
                )}
            </div>
