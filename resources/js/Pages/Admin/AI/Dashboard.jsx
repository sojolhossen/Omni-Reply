...
const PROVIDER_LABELS = { openai: 'OpenAI', anthropic: 'Anthropic', gemini: 'Google Gemini', nvidia: 'NVIDIA NIM' };
const PROVIDER_COLORS = { openai: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400', anthropic: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400', gemini: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400', nvidia: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' };
