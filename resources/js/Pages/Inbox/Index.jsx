            ...
            <div className="flex items-start gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between gap-1.5 mt-0.5">
                        <p className={`text-xs truncate flex-1 ${unreadCount > 0 ? 'font-semibold text-neutral-900 dark:text-neutral-100' : 'text-neutral-400 dark:text-neutral-500'}`}>
                            {formatLastMsgPreview(lastMsg)}
                        </p>
                        {unreadCount > 0 && (
...
export default function InboxIndex({ conversations: initialConversations, filters, labels = [], channelAccounts = [], unreadCounts: initialUnreadCounts = {} }) {
    const { t } = useTranslation();
    const { props } = usePage();
            ...
            .listen('.MessageReceived', (e) => {
                setConversations(prev => {
                    ...
                    return {
                        ...prev,
                        data: [
                            { ...exists, unread_count: (Number(exists.unread_count) || 0) + 1, last_message_at: e.created_at, last_message: { body: e.body } },
    ...
    // High-speed real-time polling (1.5s) for instant conversation list updates
    useEffect(() => {
        ...
        const interval = setInterval(checkConversations, 1500);
